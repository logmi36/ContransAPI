...
namespace CtrApp8.Helpers
{
    public static class ImagerLib
    {
        ...
        public static void PerformImageResizeAndPutOnCanvas(string pFilePath_pFileName, int pWidth, int pHeight, string pFilePath_pOutputFileName)
        {

            System.Drawing.Image imgBef;
            imgBef = System.Drawing.Image.FromFile(pFilePath_pFileName);


            System.Drawing.Image _imgR;
            _imgR = ImagerLib.Resize(imgBef, pWidth, pHeight, true);


            //System.Drawing.Image _img2;
            //_img2 = ImagerLib.PutOnCanvas(_imgR, pWidth, pHeight, System.Drawing.Color.Black);

            //Save JPEG  
            ImagerLib.SaveJpeg(pFilePath_pOutputFileName, _imgR);
